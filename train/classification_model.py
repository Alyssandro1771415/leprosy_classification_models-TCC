...
train_generator = train_datagen.flow_from_directory('data/Atlas_Dermatology/raw/train_images_classification',
                                                    target_size = (224,224),
                                                    color_mode = 'rgb',
                                                    batch_size = 32,
...
validation_generator = train_datagen.flow_from_directory('data/Atlas_Dermatology/raw/train_images_classification',
                                                        target_size = (224,224),
                                                        color_mode = 'rgb',
                                                        batch_size = 32,
                                                        class_mode = 'categorical',
