...
data_dir = 'data/atlas_dermatology/raw/train_images_binary'
...
save_model(modelo_binario, "modelo_binario_atlas_dermatology", dataset="atlas")
...
test_loss, test_accuracy = modelo_binario.evaluate(test_generator, verbose=0)
...
overfitting_report(
    history,
    metrics_dir() / "modelo_binario_atlas_dermatology_overfitting.json",
)