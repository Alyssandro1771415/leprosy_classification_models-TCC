...
save_model(modelo_classificacao, "modelo_classificacao_do_zero_atlas_dermatology", dataset="atlas")

# Salva o histórico de treinamento separadamente
import pickle

atlas_models = models_dir("atlas")
with open(atlas_models / "modelo_classificacao_do_zero_history.pkl", "wb") as f:
...
with open(atlas_models / "modelo_classificacao_do_zero_info.pkl", "wb") as f:
    pickle.dump(dataset_info, f)

print(f"✅ Modelo salvo em: {atlas_models / 'modelo_classificacao_do_zero_atlas_dermatology.keras'}")
print(f"✅ Histórico salvo em: {atlas_models / 'modelo_classificacao_do_zero_history.pkl'}")
print(f"✅ Informações do dataset salvas em: {atlas_models / 'modelo_classificacao_do_zero_info.pkl'}")
...
test_loss, test_accuracy = modelo_classificacao.evaluate(test_dataset, verbose=0)
...
overfitting_report(
    history,
    metrics_dir() / "modelo_classificacao_do_zero_atlas_dermatology_overfitting.json",
)
