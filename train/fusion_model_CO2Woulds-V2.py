...
DATASET_DIR = "data/CO2Wounds-V2/raw/train_images_binary"
...
plt.savefig("./models/images_result/matriz_confusao_fusion_model.png", dpi=300, bbox_inches="tight")
plt.close()

joblib.dump(model, "./models/modelo_xgboost_glcm_resnet101.pkl")
...
plt.title("ROC Curve")
plt.legend()
plt.savefig("./models/images_result/classic_metrics_fusion_model.png")
